...
public class MandrillEmailService {
    ...
    public static String sendForgotPasswordMail(String userName, String newPassword, String email, String urlString) throws MalformedURLException, IOException {
    ...
    public static String sendMail(String templateName, Map<String, String> templateContent, String emailAddress, String subject) {
        Client client = ClientBuilder.newClient(new ClientConfig().register(LoggingFilter.class));
        WebTarget target = client.target("https://mandrillapp.com/api/1.0/messages/send-template.json");
