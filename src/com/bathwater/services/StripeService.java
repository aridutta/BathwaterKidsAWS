...
public class StripeService {
    ...
    static {
        Stripe.apiKey = "1".equals(System.getProperty("PRODUCTION_MODE")) ? System.getProperty("STRIPE") : System.getProperty("STRIPE_TEST");
    }
    
    public static String createUser(String token, String emailAddress) throws AuthenticationException, InvalidRequestException, APIConnectionException, CardException, APIException {
    ...
    public static ReferralCodeValidStatus populateCouponData(ReferralCodeValidStatus status, String couponID) {
        try {
            ...
            Coupon coupon = Coupon.retrieve(couponID);
            status.setAmountOff(coupon.getAmountOff());
