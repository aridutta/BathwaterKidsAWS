...
public class BathwaterRest {
    ...
    @Inject
    public BathwaterRest(IDynamoDBHelper helper, IDynamoDBScans scanHelper, IDynamoDBQueries queryHelper, IESItemQueries esQueryHelper, Random random)
    {
        dao = new DAO(helper, scanHelper, queryHelper, esQueryHelper, random);
        dao.setInstance(dao);
    }
