 ...
 * @author rajeshk
 */
public class DynamoDBScans implements IDynamoDBScans {
	...
	public List<UserTableItem> getUsersBasedOnEmail(String name) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("#email = :email")
				.withExpressionAttributeNames(nameMap).withExpressionAttributeValues(valueMap);
	...
	public List<UserTableItem> getUsersBasedOnReferralCode(String referralCode) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("#code = :code")
				.withExpressionAttributeNames(nameMap).withExpressionAttributeValues(valueMap);
	...
	public List<OAuthTableItem> getAdmins(String role) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("role != :role")
				.withExpressionAttributeValues(valueMap);
	...
	public List<UserTableItem> getUsersBasedById(String userId) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("#userid = :userid")
				.withExpressionAttributeNames(nameMap).withExpressionAttributeValues(valueMap);
	...
	public List<InventoryTableItem> getBinByBinNumber(String binNumber) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
				.withFilterExpression("#binNumber = :binNumber").withExpressionAttributeNames(nameMap)
				.withExpressionAttributeValues(valueMap);
	...
	public List<TimeslotTableItem> getTimeslotsByDate(String date) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("#date = :date")
				.withExpressionAttributeNames(nameMap).withExpressionAttributeValues(valueMap);
	...
	public List<TimeslotTableItem> getTimeslotsByTimeAndDate(String date, String timeslot) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
				.withFilterExpression("#date = :date and #timeslot = :timeslot").withExpressionAttributeNames(nameMap)
				.withExpressionAttributeValues(valueMap);
	...
	public List<ItemTableItem> getItemsByCategory(String categoryID) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("#catID = :catID")
				.withExpressionAttributeNames(nameMap).withExpressionAttributeValues(valueMap);
	...
	public List<InventoryTableItem> getItemByUserID(String userID) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
				.withFilterExpression("#uid = :uid AND #status <> :status").withExpressionAttributeNames(nameMap)
				.withExpressionAttributeValues(valueMap);
	...
	public List<InventoryTableItem> getSharingItems() {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
				.withFilterExpression("#sharable = :sharable").withExpressionAttributeNames(nameMap)
				.withExpressionAttributeValues(valueMap);
	...
	public List<InventoryTableItem> getItemByItemCode(String itemCode) {
		DynamoDBMapper mapper = DynamoDBHelper.getInstance().getMapper();
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterConditionEntry("itemCode",
				new Condition().withAttributeValueList(new AttributeValue().withS(itemCode))
	...
	public List<UserRequestTableItem> getAllUserRequests(String status) {
		...
		return mapper.scan(UserRequestTableItem.class,
				new DynamoDBScanExpression().withFilterExpression("#status=:status")
						.withExpressionAttributeNames(statusMap).withExpressionAttributeValues(valueMap));
	...
	public int getBookedCountForTimeslot(String date, String time) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
				.withFilterExpression("#date = :date and #time = :time").withExpressionAttributeNames(nameMap)
				.withExpressionAttributeValues(valueMap);
	...
	public List<UserRequestTableItem> getTodaysUserRequestsByDriverID(String driverID) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
				...
				.withExpressionAttributeValues(valueMap).withExpressionAttributeNames(nameMap);
	...
	public List<UserRequestTableItem> getTodaysPickups() {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
				.withFilterExpression("#date=:today and #type=:type").withExpressionAttributeNames(nameMap)
				.withExpressionAttributeValues(valueMap);
	...
	public List<ServiceZipCodeTableItem> getZipCodeByZipCode(String zipCode) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("#zipcode = :zipcode")
				.withExpressionAttributeNames(nameMap).withExpressionAttributeValues(valueMap);
