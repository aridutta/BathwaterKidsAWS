 ...
 * @author rajeshk
 */
public class ProfilePictureDatabaseUtil {
    private static final String BUCKET_NAME  = "1".equals(System.getProperty("PRODUCTION_MODE")) ? "bathwater.profile-pictures" : "bathwater.profile-pictures.dev";
    ...
    public static void uploadImage(String fileName, InputStream inStream) throws IOException {
